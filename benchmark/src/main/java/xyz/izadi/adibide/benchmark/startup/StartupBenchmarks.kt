package xyz.izadi.adibide.benchmark.startup
 ...
 * ```
 * ./gradlew :benchmark:connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.androidx.benchmark.enabledRules=Macrobenchmark
 * ```
 *
...
class StartupBenchmarks {
    ...
    @Test
    fun startupCompilationBaselineProfile() = benchmark(
